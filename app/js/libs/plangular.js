(function(f) {
    ...
    return (function e(t, n, r) {
        ...
        4: [
            ...
            { "browser-jsonp": 5, corslite: 6, "query-string": 7 }
        ],
        5: [
            function(require, module, exports) {
                (function() {
                    ...
                    JSONP = function(options) {
                        ...
                        if (params.beforeSend({}, params) !== false) {
                            callback = params.data[options.callbackName || "callback"] =
                                "jsonp_" + randomString(15);
        ...
        8: [
            function(require, module, exports) {
                ...
                plangular.directive("plangular", [
                    "$timeout",
                    "plangularConfig",
                    function($timeout, plangularConfig) {
                        ...
                        return {
                            ...
                            link: function(scope, elem, attr) {
                                ...
                                function createSrc(track) {
                                    if (track.stream_url) {
                                        var sep =
                                            track.stream_url.indexOf("?") === -1 ? "?" : "&";
                                        track.src =
                                            track.stream_url + sep + "client_id=" + client_id;
                                    }
                                    return track;
                                }

                                if (src) {
                                    resolve({ url: src, client_id: client_id }, function(
                                        err,
                                        res
                                    ) {
                                        if (err) {
                                ...
                                player.audio.addEventListener("timeupdate", function() {
                                    if (!scope.$$phase &&
                                        scope.track.src === player.audio.src
                                    ) {
                                        $timeout(function() {
            ...
            { "audio-player": 1, hhmmss: 3, "soundcloud-resolve-jsonp": 4 }
        ]
    }, {}, [8])(8);
});